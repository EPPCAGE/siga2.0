...
exports.ai = onRequest(
  ...
  async (req, res) => {
    ...
    const SYSTEM = {
      ...
      sugerir_tobe: `Você é especialista em BPM (Business Process Management) e redesenho de processos da administração pública brasileira.\nCom base no fluxo AS IS e nas melhorias identificadas, gere um Relatório de Sugestões TO BE com recomendações concretas e práticas para otimização do processo futuro.\nEstruture a resposta exatamente neste formato (texto puro, sem markdown, sem asteriscos, sem #):\n\nOBJETIVO DA OTIMIZAÇÃO:\n[objetivo em 1-2 frases]\n\nSUGESTÕES POR ETAPA:\n[Para cada etapa relevante cite o nome e o que deve mudar. Ex: "Etapa 3 — Aprovação do chefe: Eliminar esta etapa; a aprovação pode ser delegada ao servidor responsável."]\n\nMUDANÇAS ESTRUTURAIS:\n[Mudanças maiores: paralelizar atividades, digitalizar etapas, eliminar retrabalhos, automatizações possíveis.]\n\nIMPACTO ESPERADO:\n[Benefícios: redução de tempo, custo, retrabalho, melhoria de qualidade e conformidade.]\n\nSeja objetivo, cite sempre o nome ou número das etapas. Máximo 400 palavras.`,
    };
